...
namespace Dacs7
{
    public sealed partial class Dacs7Server
    {
        ...
        public Dacs7Server(string address, PlcConnectionType connectionType = PlcConnectionType.Pg, int timeout = 5000, ILoggerFactory loggerFactory = null, int autoReconnectTime = 5000)
        {
